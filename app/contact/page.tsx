/**
 * @file page.tsx
 * @description Contact page for <i>FIRST</i> Global Team Kenya with secure form validation
...
// Social media links
const socialLinks = [
  { icon: Facebook, name: 'Facebook', url: 'https://m.facebook.com/fgckenya/', color: 'hover:text-blue-600' },
  { icon: Twitter, name: 'X (Twitter)', url: 'https://x.com/fgc_kenya?lang=en', color: 'hover:text-blue-400' },
  { icon: Instagram, name: 'Instagram', url: 'https://www.instagram.com/fgc_kenya/', color: 'hover:text-pink-600' },
  { icon: Youtube, name: 'YouTube', url: 'https://www.youtube.com/@fgc_kenya', color: 'hover:text-red-600' },
]
      ...
      <section className="py-16 overflow-hidden">
        <div className="container px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            {/* Contact Form - Temporarily Disabled (Backend Not Ready) */}
            {/* <div className="mb-12">
              <h2 className="text-2xl font-bold mb-6 text-center">Send us a Message</h2>
              <p className="text-center text-muted-foreground mb-8">
                Our contact form is coming soon. In the meantime, please reach out via email or social media.
              </p>
            </div> */}

            {/* Map & Additional Info - Centered */}
