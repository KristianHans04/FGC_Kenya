    ...
    <div className="min-h-screen bg-background p-4 md:p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6 rounded-lg overflow-hidden">
          <div className="p-4 bg-card border-2 border-green-600/20">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                <CalendarIcon className="h-6 w-6 text-green-600" />
                <h1 className="text-xl sm:text-2xl font-bold text-card-foreground">Calendar Management</h1>
              </div>
        ...
        {loading ? (
          ...
          <div className="bg-card border-2 border-green-600/20 rounded-lg p-2 sm:p-4 overflow-x-auto">
            <CalendarView
              events={events}
        ...
        {/* Upcoming Events List - Responsive grid */}
                ...
                >
                  ...
                  {event._count?.attendees > 0 && (
                    <p className="text-xs text-muted-foreground mt-1">
                      {event._count.attendees} attendee(s)
                    </p>
                  )}
                </Link>
              ))}
...
function getEventColor(type: string) {
  switch (type) {
    ...
    case 'TEAM_BUILD': return 'bg-yellow-500'
